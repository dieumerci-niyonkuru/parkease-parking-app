...
class ParkingFacility {
  ...
  const ParkingFacility({
    ...
    this.ratePerHour = 500, // Default for Rwanda standard
  });
  ...
  factory ParkingFacility.fromJson(Map<String, dynamic> j) => ParkingFacility(
    ...
    ratePerHour:  double.tryParse(j['rate_per_hour']?.toString() ?? '500') ?? 500,
  );

  static List<ParkingFacility> get mockList => [
    const ParkingFacility(parkingId:101, fullParkName:'Downtown Garage',     address:'123 KN 3 Ave, Kigali',       parkingLots:250, dbId:1, dbName:'Central DB', recordId:'1-101', ratePerHour: 600),
    const ParkingFacility(parkingId:102, fullParkName:'Kigali Airport Park', address:'500 Airport Road, Kanombe',   parkingLots:500, dbId:1, dbName:'Central DB', recordId:'1-102', ratePerHour: 1000),
    const ParkingFacility(parkingId:103, fullParkName:'City Mall Parking',   address:'KG 11 Ave, Nyarugenge',       parkingLots:180, dbId:1, dbName:'Central DB', recordId:'1-103', ratePerHour: 500),
    const ParkingFacility(parkingId:104, fullParkName:'Remera Business Hub', address:'KG 9 Road, Remera',           parkingLots:120, dbId:2, dbName:'East DB',    recordId:'2-104', ratePerHour: 400),
    const ParkingFacility(parkingId:105, fullParkName:'Kimihurura Plaza',    address:'KG 622 St, Kimihurura',       parkingLots:80,  dbId:2, dbName:'East DB',    recordId:'2-105', ratePerHour: 500),
    const ParkingFacility(parkingId:106, fullParkName:'Nyamirambo Centre',   address:'KN 47 St, Nyamirambo',        parkingLots:95,  dbId:3, dbName:'West DB',    recordId:'3-106', ratePerHour: 300),
  ];
}
