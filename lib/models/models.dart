...
class ParkingFacility {
  ...
  factory ParkingFacility.fromJson(Map<String, dynamic> j) => ParkingFacility(
    parkingId:    j['parking_id']     ?? 0,
    fullParkName: j['full_park_name'] ?? '',
    address:      j['address']        ?? '',
    parkingLots:  j['parking_lots']   ?? 0,
    dbId:         j['db_id']          ?? 1,
    dbName:       j['db_name']        ?? '',
  ...
  static List<ParkingFacility> get mockList => [
    const ParkingFacility(parkingId:101, fullParkName:'Downtown Garage',     address:'123 KN 3 Ave, Kigali',       parkingLots:250, dbId:1, dbName:'Central DB', recordId:'1-101'),
    const ParkingFacility(parkingId:102, fullParkName:'Kigali Airport Park', address:'500 Airport Road, Kanombe',   parkingLots:500, dbId:1, dbName:'Central DB', recordId:'1-102'),
    const ParkingFacility(parkingId:103, fullParkName:'City Mall Parking',   address:'KG 11 Ave, Nyarugenge',       parkingLots:180, dbId:1, dbName:'Central DB', recordId:'1-103'),
    const ParkingFacility(parkingId:104, fullParkName:'Remera Business Hub', address:'KG 9 Road, Remera',           parkingLots:120, dbId:2, dbName:'East DB',    recordId:'2-104'),
    const ParkingFacility(parkingId:105, fullParkName:'Kimihurura Plaza',    address:'KG 622 St, Kimihurura',       parkingLots:80,  dbId:2, dbName:'East DB',    recordId:'2-105'),
    const ParkingFacility(parkingId:106, fullParkName:'Nyamirambo Centre',   address:'KN 47 St, Nyamirambo',        parkingLots:95,  dbId:3, dbName:'West DB',    recordId:'3-106'),
    const ParkingFacility(parkingId:107, fullParkName:'Kacyiru Government',  address:'KG 3 Ave, Kacyiru',           parkingLots:310, dbId:1, dbName:'Central DB', recordId:'1-107'),
    const ParkingFacility(parkingId:108, fullParkName:'Gisozi Tech Park',    address:'KG 7 Ave, Gisozi',            parkingLots:200, dbId:1, dbName:'Central DB', recordId:'1-108'),
    const ParkingFacility(parkingId:109, fullParkName:'Kimironko Market',    address:'KG 15 Rd, Kimironko',         parkingLots:160, dbId:2, dbName:'East DB',    recordId:'2-109'),
    const ParkingFacility(parkingId:110, fullParkName:'Kicukiro Center',     address:'KK 15 Rd, Kicukiro',          parkingLots:130, dbId:3, dbName:'West DB',    recordId:'3-110'),
  ];
}
