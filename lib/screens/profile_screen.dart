                ...
                background: Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [AppTheme.primary.withOpacity(0.2), AppTheme.bgDeep],
                    ...
                    Stack(alignment: Alignment.bottomRight, children: [
                      Hero(
                        ...
                        child: CircleAvatar(
                          ...
                          child: Text(initials, style: const TextStyle(fontSize: 36, fontWeight: FontWeight.w900, color: Colors.white)),
                        ),
                      ),
                      Container(
